...
def initConnectors(self):
    ...
    sendsignal.clicked.connect(lambda:functions.sendSignal(self,originalSignalViewPort,reconstructedSignalViewPort,differenceBetweenSignalsViewPort,sampleController,sampleRatioLabel,fmaxradio,hertzradio))
    ...
    sampleController.setMaximum(100)
    sampleController.setValue(0)
    ...
    loadCsv.clicked.connect(lambda:functions.browse(self,originalSignalViewPort,reconstructedSignalViewPort,differenceBetweenSignalsViewPort,sampleController,sampleRatioLabel,fmaxradio,hertzradio))
