...
def sendSignal(self,viewportup,viewportmiddle,viewportdown,sampleController,sampleRatioNumber,fmaxradio,hertzradio):
...
def browse(self, viewportup, viewportmiddle, viewportdown, sampleController, sampleRatioNumber,fmaxradio,hertzradio):
    global ComposedSignal
    global maxFreq
    global snr_signal
...
def applychanges(fmaxradio, hertzradio, sampleController, sampleRatioLabel):
    ...
    if fmaxradio.isChecked():
        ...
        sampleController.setMaximum(int(200))
